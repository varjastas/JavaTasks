...
public class Solution {
    ...
    public static void main(String[] args) {
        var productStream = Stream.of(
                ...
                new Product("Buckwheat", LocalDate.of(2020, Month.MARCH, 1)),
                new Product("Rice", LocalDate.of(2020, Month.MAY, 11)),
                new Product("Wine", LocalDate.of(2020, Month.JANUARY, 10)),
                new Product("Tea", LocalDate.of(2020, Month.AUGUST, 27)),
                new Product("Salt", LocalDate.of(2020, Month.DECEMBER, 15))
        );
